 ...
 *
 */
!function(a){var c=jsless.logger;var b={settings:{behavior:{name:null,event:"click",eventSource:"self",target:"self",delay:-1,params:[],dynamic:[],stopEventPropagation:false}},behaviors:{execute:function(f,d,g,j){var k=a.extend(true,{},jsless.settings.behavior,j.behavior,{name:"execute",object:"jQuery",method:null},g);if(!k.method){c.error("execute method not specified: "+JSON.stringify(k))}var h=jsless.compileParams(k.dynamic,f,d);var e=jsless.getSelector(k.eventSource,f,d).getVal();var l=jsless.getSelector(k.target,f,d);var i=function(p){var q=k.params.slice(0);if(k.stopEventPropagation){p.stopPropagation()}c.debug(k.name+" event:"+k.event+" method: "+k.method+"\r\n\t :: "+JSON.stringify(k));var r=d.triggerHandler("jsless-"+k.name+"-begin");if(r===undefined||r){var m=l.getVal();var o=jsless.getParams(h);a.each(o,function(s,t){if(typeof o[s]==="object"){a.extend(true,q[s],o[s])}else{q[s]=o[s]}});var n=function(){d.triggerHandler("jsless-"+k.name+"-beforecomplete");var t=m;var s=m[k.method];a.each(q,function(v,w){if(q[v]=="@event"){q[v]=p}if(q[v]=="@target"){q[v]=m}});if(k.object!="jQuery"){var t=window;a.each(k.object.split("."),function(v,w){t=t[w]});var s=t[k.method]}var u=s.apply(t,q);d.triggerHandler("jsless-"+k.name+"-complete")};if(k.delay<0){n()}else{setTimeout(n,k.delay)}}};if(k.event=="load"){f.one("jsless-widget-complete",i)}else{d.bind(k.event,i)}},keyclick:function(f,d,g,h){var j=a.extend(true,{},jsless.settings.behavior,h.behavior,{name:"keyclick",event:"keydown",target:"self",keycode:13},g);var i=j.params;var e=jsless.getSelector(j.eventSource,f,d).getVal();var k=jsless.getSelector(j.target,f,d);e.bind(j.event,function(n){c.debug(j.name+" event:"+j.event+"\r\n\t :: "+JSON.stringify(j));var o=d.triggerHandler("jsless-"+j.name+"-begin");if(o===undefined||o){var m=(n.keyCode?n.keyCode:n.which);if(m==j.keycode){n.preventDefault();var l=k.getVal();l.triggerHandler("click")}}})},toggleClass:function(f,d,g,h){var j=a.extend(true,{},jsless.settings.behavior,h.behavior,{name:"toggleClass",className:null},g);if(!j.className){c.error("className not specified: "+JSON.stringify(j))}var i=j.params;var e=jsless.getSelector(j.eventSource,f,d).getVal();var k=jsless.getSelector(j.target,f,d);e.bind(j.event,function(o){c.debug(j.name+" event:"+j.event+"\r\n\t :: "+JSON.stringify(j));var p=d.triggerHandler("jsless-"+j.name+"-begin");if(p===undefined||p){var m=k.getVal();var l=a(o.target).parents(j.target).addBack(j.target).first();var n=j.className;m.removeClass(n);l.addClass(n)}})}}};c.info("Loading Behaviors ...");window.jsless=a.extend(true,b,window.jsless||{})}(window.jQuery);